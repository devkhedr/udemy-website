...
function StickyCard({ course }) {
  ...
  return (
    <Sticky
      ...
      top={0}
      enabled={height}
      enableTransforms={height}
    >
      <div className={styles.card}>
        <img
          src={course.image}
          alt="course thumb"
          className={height ? styles.hide : styles.image}
        />
        ...
        <span className={styles.data}>
          <i className="fa-solid fa-play"></i> 14 hours on-demand video
        </span>
        <span className={styles.data}>
          <i className="fa-regular fa-file"></i> 1 article
        </span>
        <span className={styles.data}>
          <i className="fa-solid fa-file-arrow-down"></i> 3 downloadable
          resources
        </span>
        <span className={styles.data}>
